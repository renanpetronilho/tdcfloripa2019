...
*************************************************************
*/
package io.platformbuilders.accountapi.utils;
...
public class LoggingAspect {
    ...
    @Around("execution(* io.platformbuilders.accountapi..*Service*.*(..)) || execution(* io.platformbuilders.accountapi..*Resource*.*(..)) || execution(* io.platformbuilders.accountapi..*Client*.*(..)) || execution(* io.platformbuilders.accountapi..*Repository*.*(..))")
